(function (h, w) {
    ...
    var f = Math, B = w.createElement("div").style, p = function () {
            ...
            return !1
        }(), k = p ? "-" + p.toLowerCase() + "-" : "", q = r("transform"), K = r("transitionProperty"),
        t = r("transitionDuration"), L = r("transformOrigin"), M = r("transitionTimingFunction"),
        C = r("transitionDelay"), D = /android/gi.test(navigator.appVersion),
        G = /iphone|ipad/gi.test(navigator.appVersion), x = /hp-tablet/gi.test(navigator.appVersion),
        H = r("perspective") in B, n = "ontouchstart" in h && !x, I = !1 !== p, N = r("transition") in B,
        E = "onorientationchange" in h ? "orientationchange" : "resize", F = n ? "touchstart" : "mousedown",
        y = n ? "touchmove" : "mousemove", z = n ? "touchend" : "mouseup", A = n ? "touchcancel" : "mouseup",
        v = !1 === p ? !1 : {
            "": "transitionend",
        ...
        s = H ? " translateZ(0)" : "", x = function (b, a) {
            var c = this, d;
    ...
    x.prototype = {
        ...
        _move: function (b) {
            var a = n ? b.touches[0] : b, c = a.pageX - this.pointX, d = a.pageY - this.pointY, e = this.x + c,
                g = this.y + d, h = b.timeStamp || Date.now();
        ...
        _end: function (b) {
            if (!n || 0 === b.touches.length) {
                var a = this, c = n ? b.changedTouches[0] : b, d, e, g = {dist: 0, time: 0}, l = {dist: 0, time: 0},
